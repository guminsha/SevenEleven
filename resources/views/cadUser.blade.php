        ...
        <form action="{{route('addCliente')}}" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="password" class="form-control" id="inputConfirmPassword" name="confirmarSenha" placeholder="Confirmar Senha">
                </div>
            </div>
            <div class="form-row">
            ...
            <div id="divTel">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPhone" name="telefone" placeholder="Telefone">
                </div>
            </div>
            <h3>Endereço:</h3>
            <div class="form-row">
