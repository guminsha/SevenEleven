...
<body>
    ...
    <div id="formulario">
        ...
        <form action="{{route('addFuncionario')}}" method="post">
        @csrf
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="password" class="form-control" id="inputConfirmPassword" placeholder="Confirmar Senha" name="confirmarSenha">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="inputDataNasci">Data de Nascimento:</label>
                    <input type="date" class="form-control" id="inputDataNasci" name="dataNascimento">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-2">
                    <label for="inputDataAdmi">Data de Admissão:</label>
                    <input type="date" class="form-control" id="inputDataAdmi" name="dataAdmissao">
                </div>
            </div>
            <div id="divPermissao">
                <div class="form-group col-md-3">
                        <label for="inputPermissao">Nível de Permissão:</label>
                        <select id="inputPermissao" class="form-control" name="nivelPermissao">
                            <option selected value="Escolher">Escolher...</option>
                            <option value="1">1- Básica</option>
                            <option value="2">2- Intermediária</option>
                            <option value="3">3- Acesso Total</option>
                        </select>
                </div>
            </div>
            <div id="divRadio">
            ...
            <div id="divTel">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inputPhone" placeholder="Telefone" name="telefone">
                </div>
            </div>
            <h3>Endereço:</h3>
            <div class="form-row">
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="inputCEP" placeholder="57057-150" name="cep">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="inputComp" placeholder="nº992 vizinho ao Banco Itaú" name="complemento">
                </div>
            </div>
            <div id="divButtonCad">
