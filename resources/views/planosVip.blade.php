...
<head>
    ...
    <link href="{{asset('css/stylePlanos.css')}}" rel="stylesheet" type="text/css" />
...
<body>
    <form action="{{route('pagamentoVip')}}" method="post" enctype="multipart/form-data">
        ...
        <div id="radioPlanos">
            <input type="radio" id="idMensal" value="Plano Bronze !" name="plano" checked="true" class="radioMensal"/>
            <label for="idMensal" class="radioMensal" id="labelMensal">Plano Bronze !</label>

            <input type="radio" id="idTrimestral" value="Plano Prata !" name="plano" class="radioTrimestral"/>
            <label for="idTrimestral" class="radioTrimestral" id="labelTrimestral">Plano Prata !</label>

            <input type="radio" id="idSemestral" value="Plano Ouro !" name="plano" class="radioSemestral"/>
            <label for="idSemestral" class="radioSemestral" id="labelSemestral">Plano Ouro !</label>
            
            <input type="radio" id="idAnual" value="Plano Platina !" name="plano" class="radioAnual"/>
            <label for="idAnual" class="radioAnual" id="labelAnual">Plano Platina !</label>
        </div>
        <div id="divDesconto">
            <label for="idDesconto" id="descontoNome">Cupom de Desconto:</label>
            <input type="text" id="idDesconto" name="desconto" placeholder=""/>
        </div>
        <input type="submit" class="btn-submit grid-item" value="Prosseguir" />
        <input type="button" class="btn-voltar grid-item" value="Voltar" onclick="window.location.href='{{ route('principal')}}'" />
    </form>
